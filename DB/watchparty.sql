...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `first_name`, `photo_url`, `role`, `enabled`, `address_id`, `create_date`, `update_date`) VALUES (6, 'reid', '$2a$10$nShOi5/f0bKNvHB8x0u3qOpeivazbuN0NE4TO0LGvQiTMafaBxLJS', 'reid@sd.com', 'Reid', 'https://media.licdn.com/dms/image/C5603AQGqzZiNM7FsAg/profile-displayphoto-shrink_800_800/0/1516526982038?e=1704326400&v=beta&t=drKSnKL0GdXdGuhp91hm-FmU7u2C-O7WiONlSR6Mw_o', 'standard', 1, 13, '2023-11-01', '2023-11-01');
...
INSERT INTO `team` (`id`, `name`, `logo_url`, `team_website_url`, `sport_id`) VALUES (30, 'Arizona Diamondbacks', 'https://www.mustangsnation.com/wp-content/uploads/2021/07/Arizona-Diamondbacks-Logo-PNG-715x715-1.jpg', 'https://i.pinimg.com/564x/b0/4f/e4/b04fe4e175ac87a45d2f6f88dad1438f.jpg', 4);
...
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (6, 'Huskers Vs Iowa', '2023-11-24', '120000', 'In the FINAL regular season game of the year  the Huskers try to retain posession of the Hero\'s Cup and down the Hawkeyes for a second consecutive year', 0, 1, 1, 1, '2023-11-01', '2023-11-01', 1, 'https://hawkeyesports.com/imgproxy/Uw4bxIPJmgr6911AAwaXr0p7vREVpprkdhzWlXihqgE/fit/1000/1000/ce/0/aHR0cHM6Ly9zdG9yYWdlLmdvb2dsZWFwaXMuY29tL2hhd2tleWVzcG9ydHMtY29tLzIwMjEvMTEvOWU3OTY5NGItMjFpYWZiYWxsX2hlcm9lc2dhbWUxOTIweDEwODAtY29weS5qcGc.jpg');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (7, 'Seahawks @ Ravens', '2023-11-05', '130000', 'Seahawks Travel to the east coast to take on the Ravens in Baltimore', 0, 1, 5, 10, '2023-11-01', '2023-11-01', 27, 'https://static.clubs.nfl.com/image/upload/t_editorial_landscape_12_desktop/f_auto/seahawks/d3zwjqkaqbonfw2wvqst.jpg');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (8, 'Ravens Vs Seahawks', '2023-11-05', '130000', 'The Ravens are riding high in first place, with perhaps one of the most complete rosters in football. It\'s going to be one hell of a challenge for the Seahawks to take them down at home.  ', 0, 1, 9, 9, '2023-11-01', '2023-11-01', 26, 'https://s.yimg.com/ny/api/res/1.2/mTdtK94vLjMYQB_u90XnMQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTU0MDtjZj13ZWJw/https://media.zenfs.com/en/seattle_seahawks_wire_usa_today_sports_articles_798/3d6e016a5003926768132ddf05807c1f');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (9, 'World Series Game 5 ', '2023-11-01', '170000', 'Diamondbacks try to climb their way back into the fight for the World Series', 1, 1, 9, 9, '2023-10-31', '2023-10-31', 30, 'https://content.sportslogos.net/logos/4/484/full/_mlb_world_series_logo_primary_dark_2023_sportslogosnet-3607.png');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (10, 'Mavericks Vs Nuggets', '2023-11-03', '220000', 'Mav\'s defend home court against the Denver Nuggets ', 0, 1, 8, 8, '2023-11-01', '2023-11-01', 28, 'https://clutchpoints.com/_next/image?url=https%3A%2F%2Fwp.clutchpoints.com%2Fwp-content%2Fuploads%2F2023%2F09%2FThumbs-14-3-1.jpg&w=3840&q=75');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (11, 'Nuggets @ Mavericks', '2023-11-03', '220000', 'Nuggets travel to Texas to take on the top seated Mavericks in Dallas', 0, 1, 6, 5, '2023-11-01', '2023-11-01', 19, 'https://clutchpoints.com/_next/image?url=https%3A%2F%2Fwp.clutchpoints.com%2Fwp-content%2Fuploads%2F2023%2F02%2FNBA_Odds_Mavericks_vs._Nuggets_prediction_pick_how_to_watch.jpg&w=3840&q=75');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (12, 'Monday Night Football Broncos @ Bills', '2023-11-13', '201500', 'Its Monday Night Live !!!!!', 0, 1, 6, 4, '2023-11-02', '2023-11-02', 18, 'https://shop.buffalobills.com/cdn/shop/files/BILLHP012600A.jpg?v=1692026280');
INSERT INTO `party` (`id`, `title`, `party_date`, `start_time`, `description`, `completed`, `enabled`, `venue_id`, `user_id`, `create_date`, `update_date`, `team_id`, `image_url`) VALUES (13, 'SD40 Grad Party ', '2023-11-06', '180000', 'Congrats!!! To the newest Skill Distillery Graduates...', 0, 1, 6, 1, '2023-08-01', '2023-11-02', 29, 'https://aaysrental.com/sites/default/files/blog-headers/graduation%20caps_0.jpg');
...
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (11, 5);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (12, 4);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (10, 8);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (8, 7);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (9, 9);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (12, 6);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 1);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 5);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 6);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 7);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 8);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 9);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 10);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 11);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 12);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 13);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 14);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 15);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 16);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 17);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 18);
INSERT INTO `party_goer` (`party_id`, `user_id`) VALUES (13, 4);
